...
export default function PropertyCard({ property }: { property: Property }) {
  const sc = statusColors[property.status] ?? { bg: "#6b7280", text: "white" };
    ...
    >
      ...
      <div className="relative overflow-hidden bg-emerald-50" style={{ aspectRatio: "4/3" }}>
        ...
        <div className="absolute inset-0"
          style={{ background: "linear-gradient(to top, rgba(5,46,22,0.75) 0%, transparent 55%)" }} />
        ...
        {/* Instagram button — top right, stops propagation */}
          {/* {property.instagramUrl && (
            <a
              ...
              className="absolute top-3 right-3 flex items-center gap-1.5 px-2.5 py-1.5 rounded-full text-[11px] font-semibold text-white transition-all hover:scale-110"
              style={{
      ...
      {/* Content */}
      <div className="p-5">
        <h3 className="font-display font-semibold text-base leading-snug mb-1.5 line-clamp-1"
          style={{ color: "#0A4D2E" }}>
          {property.title}
        </h3>
